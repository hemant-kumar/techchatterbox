 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cb=TN;function Pb(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Dp,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Lr.create("bad-app-name",{appName:String(i)});if(n||(n=_b()),!n)throw Lr.create("no-options");const o=Jc.get(i);if(o){if(Pp(n,o.options)&&Pp(r,o.config))return o;throw Lr.create("duplicate-app",{appName:i})}const s=new Mk(i);for(const l of Op.values())s.addComponent(l);const a=new CN(n,r,s);return Jc.set(i,a),a}function Rb(t=Dp){const e=Jc.get(t);if(!e&&t===Dp&&_b())return Pb();if(!e)throw Lr.create("no-app",{appName:t});return e}function Mr(t,e,n){var r;let i=(r=SN[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const o=i.match(/\s|\//),s=e.match(/\s|\//);if(o||s){const a=[`Unable to register library "${i}" with version "${e}":`];o&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&s&&a.push("and"),s&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ci.warn(a.join(" "));return}xa(new $o(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PN="firebase-heartbeat-database",RN=1,Ea="firebase-heartbeat-store";let ih=null;function kb(){return ih||(ih=Gk(PN,RN,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Ea)}catch(n){console.warn(n)}}}}).catch(t=>{throw Lr.create("idb-open",{originalErrorMessage:t.message})})),ih}async function kN(t){try{const n=(await kb()).transaction(Ea),r=await n.objectStore(Ea).get(Nb(t));return await n.done,r}catch(e){if(e instanceof ji)Ci.warn(e.message);else{const n=Lr.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ci.warn(n.message)}}}async function Iv(t,e){try{const r=(await kb()).transaction(Ea,"readwrite");await r.objectStore(Ea).put(e,Nb(t)),await r.done}catch(n){if(n instanceof ji)Ci.warn(n.message);else{const r=Lr.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Ci.warn(r.message)}}}function Nb(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hm{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.se(r),this.oe=r=>n.writeSequenceNumber(r))}se(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.oe&&this.oe(e),e}}Hm._e=-1;function rd(t){return t==null}function Xc(t){return t===0&&1/t==-1/0}function aO(t){return typeof t=="number"&&Number.isInteger(t)&&!Xc(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zx(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Xc(e)?"-0":e}}function eE(t){return{integerValue:""+t}}function RO(t,e){return aO(e)?eE(e):Zx(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ld{constructor(e,n,r,i,o){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,sl.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new ld(W.min(),i,new Ce(le),tr(),te())}}class sl{constructor(e,n,r,i,o){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new sl(r,n,te(),te(),te())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lL{constructor(e){this.ct=e}}function cL(t){const e=nL({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?eu(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class TL{constructor(){this.$i=!1,this.Ui=!1,this.Wi=100,this.Gi=function(){return Ck()?8:ui.v(Hc())>0?6:4}()}initialize(e,n){this.zi=e,this.indexManager=n,this.$i=!0}getDocumentsMatchingQuery(e,n,r,i){const o={result:null};return this.ji(e,n).next(s=>{o.result=s}).next(()=>{if(!o.result)return this.Hi(e,n,i,r).next(s=>{o.result=s})}).next(()=>{if(o.result)return;const s=new EL;return this.Ji(e,n,s).next(a=>{if(o.result=a,this.Ui)return this.Yi(e,n,s,a.size)})}).next(()=>o.result)}Yi(e,n,r,i){return r.documentReadCount<this.Wi?(Cs()<=oe.DEBUG&&O("QueryEngine","SDK will not create cache indexes for query:",Ki(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Wi,"documents"),P.resolve()):(Cs()<=oe.DEBUG&&O("QueryEngine","Query:",Ki(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Gi*i?(Cs()<=oe.DEBUG&&O("QueryEngine","The SDK decides to create cache indexes for query:",Ki(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Cn(n))):P.resolve())}ji(e,n){if(e0(n))return P.resolve(null);let r=Cn(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=eu(n,null,"F"),r=Cn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const s=te(...o);return this.zi.getDocuments(e,s).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const c=this.Zi(n,a);return this.Xi(n,c,s,l.readTime)?this.ji(e,eu(n,null,"F")):this.es(e,c,n,l)}))})))}Hi(e,n,r,i){return e0(n)||i.isEqual(W.min())?P.resolve(null):this.zi.getDocuments(e,r).next(o=>{const s=this.Zi(n,o);return this.Xi(n,s,r,i)?P.resolve(null):(Cs()<=oe.DEBUG&&O("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Ki(n)),this.es(e,s,n,eO(i,-1)).next(a=>a))})}Zi(e,n){let r=new tt(Gx(e));return n.forEach((i,o)=>{od(e,o)&&(r=r.add(o))}),r}Xi(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const o=e.limitType==="F"?n.last():n.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(i)>0)}Ji(e,n,r){return Cs()<=oe.DEBUG&&O("QueryEngine","Using full collection scan to execute query:",Ki(n)),this.zi.getDocumentsMatchingQuery(e,n,Hr.min(),r)}es(e,n,r,i){return this.zi.getDocumentsMatchingQuery(e,r,i).next(o=>(n.forEach(s=>{o=o.insert(s.key,s)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $L{constructor(e,n,r,i,o){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.D_=[],this.C_=new Map,this.v_=new Set,this.F_=[],this.M_=o,this.M_.io(s=>{r.enqueueAndForget(async()=>{Bi(this)&&(O("RemoteStore","Restarting streams for network reachability change."),await async function(l){const c=K(l);c.v_.add(4),await al(c),c.x_.set("Unknown"),c.v_.delete(4),await ud(c)}(this))})}),this.x_=new UL(r,i)}}async function ud(t){if(Bi(t))for(const e of t.F_)await e(!0)}async function al(t){for(const e of t.F_)await e(!1)}function xE(t,e){const n=K(t);n.C_.has(e.targetId)||(n.C_.set(e.targetId,e),og(n)?ig(n):hs(n).Jo()&&rg(n,e))}function ng(t,e){const n=K(t),r=hs(n);n.C_.delete(e),r.Jo()&&EE(n,e),n.C_.size===0&&(r.Jo()?r.Xo():Bi(n)&&n.x_.set("Unknown"))}function rg(t,e){if(t.O_.Oe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(W.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}hs(t).c_(e)}function EE(t,e){t.O_.Oe(e),hs(t).l_(e)}function ig(t){t.O_=new HO({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),_t:e=>t.C_.get(e)||null,nt:()=>t.datastore.serializer.databaseId}),hs(t).start(),t.x_.p_()}function og(t){return Bi(t)&&!hs(t).Ho()&&t.C_.size>0}function Bi(t){return K(t).v_.size===0}function TE(t){t.O_=void 0}async function zL(t){t.C_.forEach((e,n)=>{rg(t,e)})}async function HL(t,e){TE(t),og(t)?(t.x_.S_(e),ig(t)):t.x_.set("Unknown")}async function JL(t,e,n){if(t.x_.set("Online"),e instanceof uE&&e.state===2&&e.cause)try{await async function(i,o){const s=o.cause;for(const a of o.targetIds)i.C_.has(a)&&(await i.remoteSyncer.rejectListen(a,s),i.C_.delete(a),i.O_.removeTarget(a))}(t,e)}catch(r){O("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await iu(t,r)}else if(e instanceof cc?t.O_.$e(e):e instanceof cE?t.O_.Je(e):t.O_.Ge(e),!n.isEqual(W.min()))try{const r=await wE(t.localStore);n.compareTo(r)>=0&&await function(o,s){const a=o.O_.it(s);return a.targetChanges.forEach((l,c)=>{if(l.resumeToken.approximateByteSize()>0){const u=o.C_.get(c);u&&o.C_.set(c,u.withResumeToken(l.resumeToken,s))}}),a.targetMismatches.forEach((l,c)=>{const u=o.C_.get(l);if(!u)return;o.C_.set(l,u.withResumeToken(ft.EMPTY_BYTE_STRING,u.snapshotVersion)),EE(o,l);const h=new Tr(u.target,l,c,u.sequenceNumber);rg(o,h)}),o.remoteSyncer.applyRemoteEvent(a)}(t,n)}catch(r){O("RemoteStore","Failed to raise snapshot:",r),await iu(t,r)}}async function iu(t,e,n){if(!il(e))throw e;t.v_.add(1),await al(t),t.x_.set("Offline"),n||(n=()=>wE(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{O("RemoteStore","Retrying IndexedDB access"),await n(),t.v_.delete(1),await ud(t)})}function SE(t,e){return e().catch(n=>iu(t,n,e))}async function dd(t){const e=K(t),n=qr(e);let r=e.D_.length>0?e.D_[e.D_.length-1].batchId:-1;for(;qL(e);)try{const i=await RL(e.localStore,r);if(i===null){e.D_.length===0&&n.Xo();break}r=i.batchId,WL(e,i)}catch(i){await iu(e,i)}IE(e)&&AE(e)}function qL(t){return Bi(t)&&t.D_.length<10}function WL(t,e){t.D_.push(e);const n=qr(t);n.Jo()&&n.P_&&n.I_(e.mutations)}function IE(t){return Bi(t)&&!qr(t).Ho()&&t.D_.length>0}function AE(t){qr(t).start()}async function KL(t){qr(t).d_()}async function GL(t){const e=qr(t);for(const n of t.D_)e.I_(n.mutations)}async function QL(t,e,n){const r=t.D_.shift(),i=Qm.from(r,e,n);await SE(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await dd(t)}async function YL(t,e){e&&qr(t).P_&&await async function(r,i){if(function(s){return UO(s)&&s!==C.ABORTED}(i.code)){const o=r.D_.shift();qr(r).Zo(),await SE(r,()=>r.remoteSyncer.rejectFailedWrite(o.batchId,i)),await dd(r)}}(t,e),IE(t)&&AE(t)}async function f0(t,e){const n=K(t);n.asyncQueue.verifyOperationInProgress(),O("RemoteStore","RemoteStore received new credentials");const r=Bi(n);n.v_.add(3),await al(n),r&&n.x_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.v_.delete(3),await ud(n)}async function XL(t,e){const n=K(t);e?(n.v_.delete(2),await ud(n)):e||(n.v_.add(2),await al(n),n.x_.set("Unknown"))}function hs(t){return t.N_||(t.N_=function(n,r,i){const o=K(n);return o.R_(),new VL(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)}(t.datastore,t.asyncQueue,{Po:zL.bind(null,t),To:HL.bind(null,t),u_:JL.bind(null,t)}),t.F_.push(async e=>{e?(t.N_.Zo(),og(t)?ig(t):t.x_.set("Unknown")):(await t.N_.stop(),TE(t))})),t.N_}function qr(t){return t.L_||(t.L_=function(n,r,i){const o=K(n);return o.R_(),new FL(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)}(t.datastore,t.asyncQueue,{Po:KL.bind(null,t),To:YL.bind(null,t),E_:GL.bind(null,t),T_:QL.bind(null,t)}),t.F_.push(async e=>{e?(t.L_.Zo(),await dd(t)):(await t.L_.stop(),t.D_.length>0&&(O("RemoteStore",`Stopping write stream with ${t.D_.length} pending writes`),t.D_=[]))})),t.L_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
