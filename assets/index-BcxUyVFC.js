 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v1=x.forwardRef(({color:e="currentColor",size:t=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:o="",children:i,iconNode:a,...s},l)=>x.createElement("svg",{ref:l,...g1,width:t,height:t,stroke:e,strokeWidth:r?Number(n)*24/Number(t):n,className:ym("lucide",o),...s},[...a.map(([u,c])=>x.createElement(u,c)),...Array.isArray(i)?i:[i]]));/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const y1=(e,t)=>{const n=x.forwardRef(({className:r,...o},i)=>x.createElement(v1,{ref:i,iconNode:t,className:ym(`lucide-${m1(e)}`,r),...o}));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const w1=y1("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]),x1=()=>{const{id:e}=ab(),{toast:t}=l1(),n=i1(e||"");return n?v.jsx("div",{className:"min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-16",children:v.jsx("div",{className:"container mx-auto px-4",children:v.jsxs("article",{className:"max-w-3xl mx-auto",children:[v.jsx("div",{className:"mb-8 h-[400px] overflow-hidden rounded-2xl",children:v.jsx("img",{src:"https://images.unsplash.com/photo-1488590528505-98d2b5aba04b",alt:n.title,className:"w-full h-full object-cover"})}),v.jsxs("div",{className:"mb-8",children:[v.jsxs("div",{className:"flex items-center gap-2 text-purple-600 mb-4",children:[v.jsx(w1,{size:20}),v.jsx("span",{className:"text-sm font-medium",children:n.category})]}),v.jsx("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:n.title}),v.jsxs("div",{className:"flex items-center justify-between text-gray-500",children:[v.jsxs("div",{className:"flex items-center gap-3",children:[v.jsx("img",{src:"https://images.unsplash.com/photo-1472099645785-5658abf4ff4e",alt:"Author",className:"w-10 h-10 rounded-full"}),v.jsxs("div",{children:[v.jsx("p",{className:"font-medium text-gray-900",children:n.author}),v.jsx("p",{className:"text-sm",children:n.date})]})]}),v.jsx("span",{className:"text-sm",children:n.readTime})]})]}),v.jsx("div",{dangerouslySetInnerHTML:{__html:n.content}})]})})}):(t({title:"Post not found",description:"The requested blog post could not be found.",variant:"destructive"}),v.jsx("div",{className:"min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-16",children:v.jsx("div",{className:"container mx-auto px-4",children:v.jsx("h1",{className:"text-2xl font-bold text-gray-900",children:"Post not found"})})}))},b1=new Tx,S1=()=>v.jsx(jx,{client:b1,children:v.jsxs(rx,{children:[v.jsx(jy,{}),v.jsxs(jb,{children:[v.jsx(_b,{}),v.jsxs(Sb,{children:[v.jsx(Lt,{path:"/",element:v.jsx(Lb,{})}),v.jsx(Lt,{path:"/blog",element:v.jsx(s1,{})}),v.jsx(Lt,{path:"/blog/:id",element:v.jsx(x1,{})}),v.jsx(Lt,{path:"/categories",element:v.jsx(c1,{})}),v.jsx(Lt,{path:"/authors",element:v.jsx(d1,{})}),v.jsx(Lt,{path:"/about",element:v.jsx(p1,{})}),v.jsx(Lt,{path:"/contact",element:v.jsx(f1,{})}),v.jsx(Lt,{path:"*",element:v.jsx(h1,{})})]})]})]})});sh(document.getElementById("root")).render(v.jsx(S1,{}));
